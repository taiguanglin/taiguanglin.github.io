...
out = os.path.join(CUR_DIR, 'data')          # data/ (curation terms, quotes, stats, site data)
...
<div class="nav-dropdown is-current" id="nav-dropdown">
                    <button type="button" class="nav-link nav-dropdown-toggle active" id="dropdown-toggle" aria-expanded="false" aria-controls="nav-knowledge-menu" aria-current="true">圖解 <span aria-hidden="true">▾</span></button>
                    <div class="nav-dropdown-menu" id="nav-knowledge-menu">
                        <a href="infographic.html" class="nav-dropdown-item">
                            <strong>名詞圖解</strong>
                            <span>用圖像快速認識核心概念</span>
                        </a>
                        <a href="mindmap.html" class="nav-dropdown-item">
                            <strong>坐禪與講經心智圖</strong>
                            <span>看懂名詞關聯與經典依據</span>
                        </a>
                        <a href="wenda2_mindmap.html" class="nav-dropdown-item active" aria-current="page">
                            <strong>問答錄2心智圖</strong>
                            <span>看懂 57 個高頻名詞關聯</span>
                        </a>
                    </div>
                </div>
            ...
            <div class="footer-top">
                ...
                <div class="footer-col">
                    ...
                    <ul>
                        ...
                        <li><a href="mindmap.html">坐禪與講經心智圖</a></li>
                        <li><a href="wenda2_mindmap.html">問答錄2心智圖</a></li>
...
with open('wenda2_mindmap.html', 'w', encoding='utf-8') as f:
    f.write(page)
subprocess.run(
    ['python3', os.path.join(REPO, 'tool', 'site_chrome', 'sync.py')],
    check=True,
)
