...
- 本目錄另存**自抽取版** harness（見 `mm_harness.js` 檔首說明）：直接從 repo 的 mindmap.html 抽內嵌腳本 eval 跑煙霧測試，不需 /tmp 快取——`SESSION_KNOWLEDGE.md` 第 6.3、9 節有完整用法與斷言盤點。`rv_harness.js` 已隨 `review.html` 移除。
